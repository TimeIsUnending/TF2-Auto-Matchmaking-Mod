...
mkdir "R2Northstar/mods/TimeIsUnending.AutoMatchmaking.1.0.6"
cd R2Northstar/mods/TimeIsUnending.AutoMatchmaking.1.0.6
curl -LO https://github.com/TimeIsUnending/TF2-Auto-Matchmaking-Mod/releases/download/v1.0.6/TimeIsUnending.AutoMatchmaking.1.0.6.zip
tar -xf TimeIsUnending.AutoMatchmaking.1.0.6.zip
del TimeIsUnending.AutoMatchmaking.1.0.6.zip
cd ../../..
